...
<form id="productForm" action="{{ route('products.update', $product->id) }}" method="POST"
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <input type="file" name="image1" id="image1" value="{{ $product->image1}}" class="form-control-file">
            </div>
        </div>
    </div>
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 text-center">
        ...
        <button type="button" id="updateProduct" class="btn btn-primary">Update Product</button>
    </div>
</form>
...
$(document).ready(function() {
    $("#updateProduct").click(function() {
        ...
        var formData = {
            ...
            discount_start_date: $("input[name='discount_start_date']").val(),
            discount_start_date: $("input[name='discount_start_date']").val(),
            discount_end_date: $("input[name='discount_end_date']").val(),
